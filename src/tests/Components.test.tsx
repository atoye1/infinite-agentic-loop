...
import { BackgroundLayer } from "../a";
import { TitleLayer } from "../TitleLayer";
import { DateLayer } from "../DateLayer";
import { ChartLayer } from "../ChartLayer";
import { BarChartRaceComposition } from "../a";
...
describe("React Components", () => {
  ...
  describe("BarItem", () => {
    ...
    test("should hide label when showLabel is false", () => {
      const { queryByText } = render(
        <BarItem {...defaultProps} showLabel={false} />,
      );
  ...
  describe("ChartLayer", () => {
    ...
    test("should render correct number of items", () => {
      ...
      expect(bars.length).toBeLessThanOrEqual(
        defaultProps.config.chart.visibleItemCount,
      );
    });
